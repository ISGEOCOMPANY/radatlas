LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Захворюваність серед дорослих і підлітків 1, 2, 3 груп первинного обліку",
                mapName_rus: "Заболеваемость взрослых и подростков 1, 2, 3 групп первичного учета",
                mapName_eng: "Morbidity among adults and adolescents of 1, 2, 3 groups of primary accounting",
                maxZoom: 8,
                minZoom: 5
            });

        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_60_01,
            {
                FindProperties: {
                    ukr: [
                        {
                        ...
                        {
                            "propName": "c_06_01",
                            "descr": "Захворюваність дорослих і підлітків 1, 2, 3 груп, на 10 000, 1987",
                            "type": 3
                        },
                        {
                            "propName": "c_06_02",
                        ...
                        {
                            "propName": "c_07_01",
                            "descr": "Захворюваність дорослих і підлітків області, на 10 000, 1987",
                            "type": 3
                        },
                        {
                            "propName": "c_07_02",
                        ...
                        {
                            "propName": "ILL_05",
                            "descr": "Частка визнаних хворими серед дорослих і підлітків 1, 2, 3 груп, %, 2005",
                            "type": 3
                        },
                        {
                            "propName": "INF_05",
                            "descr": "Захворюваність, на 10 000 потерпілих, інфекційні та паразитарні хвороби",
                            "type": 3
                        },
                        {
                            "propName": "NOV_05",
                    ...
                    rus: [
                        ...
                        {
                            "propName": "c_06_01",
                            "descr": "Заболеваемость взрослых и подростков области 1,2, 3 групп, на 1 000, 1987",
                            "type": 3
                        },
                        {
                            "propName": "c_06_02",
                        ...
                        {
                            "propName": "c_07_01",
                            "descr": "Заболеваемость взрослых и подростков области, на 1 000, 1987",
                            "type": 3
                        },
                        {
                            "propName": "c_07_02",
                        ...
                        {
                            "propName": "ILL_05",
                            "descr": "Доля признанных больными среди взрослых и подростков 1, 2, 3 групп, %, 2005",
                            "type": 3
                        },
                        {
                            "propName": "INF_05",
                            "descr": "Заболеваемость, на 10 000 пострадавших, инфекционные и паразитарные болезни",
                            "type": 3
                        },
                        {
                            "propName": "NOV_05",
                    ...
                    eng: [
                        ...
                        {
                            "propName": "c_06_01",
                            "descr": "Morbidity among adults and adolescents of 1, 2, 3 groups, per 10 000, 1987",
                            "type": 3
                        },
                        {
                            "propName": "c_06_02",
                        ...
                        {
                            "propName": "c_07_01",
                            "descr": "Morbidity among adults and adolescents of region, per 10 000, 1987",
                            "type": 3
                        },
                        {
                            "propName": "c_07_02",
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_60_02,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_60_03,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_60_05,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //Graph_60_lbl
        this._mapSettings.LabelLayers.push(new L.geoJson(Graph_60_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
        ...
        //Them1_60_lbl
        this._mapSettings.LabelLayers.push(new L.geoJson(Them1_60_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
        ...
        //Them2_60_lbl
        this._mapSettings.LabelLayers.push(new L.geoJson(Them2_60_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
