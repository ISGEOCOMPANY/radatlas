LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_63_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Захворюваність серед дітей до 14 років 2, 3, 4 груп первинного обліку",
                geoJsonName_rus: "Заболеваемость детей до 14 лет 2, 3, 4  групп первичного учета",
                geoJsonName_eng: "Morbidity among children under 14 of 2, 3, 4 groups of primary accounting"
            }));

        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_63_02,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_63_03,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_63_05,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //Graph_63_lbl
        this._mapSettings.LabelLayers.push(new L.geoJson(Graph_63_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
        ...
        //Them1_63_lbl
        this._mapSettings.LabelLayers.push(new L.geoJson(Them1_63_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
        ...
        //Them2_63_lbl
        this._mapSettings.LabelLayers.push(new L.geoJson(Them2_63_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
