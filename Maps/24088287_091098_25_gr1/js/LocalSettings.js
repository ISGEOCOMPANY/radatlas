LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Доза опромінення щитоподібної залози. Перша вікова група (до 1 року на момент аварії)",
                mapName_rus: "Доза облучения щитовидной железы. Первая возрастная группа (до 1 года на момент аварии)",
                mapName_eng: "Thyroid gland irradiation dose. First age group (under 1 year at the moment of accident)",
                maxZoom: 8,
                minZoom: 5
            });

        //Векторный слой по умолчанию
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_25_gr1_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Доза опромінення щитоподібної залози. Перша вікова група",
                geoJsonName_rus: "Доза облучения щитовидной железы. Первая возрастная группа",
                geoJsonName_eng: "Thyroid gland irradiation dose. First age group"
            }));
