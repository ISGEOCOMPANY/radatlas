LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Забруднення території України стронцієм-137 (станом на 10 травня 2014 року)",
                mapName_rus: "Загрязнение территории Украины стронцием-137 (по состоянию на 10 мая 2014 года)",
                mapName_eng: "Contamination of the territory of Ukraine by strontium-137 (as of May 10, 2014)",
                maxZoom: 8,
                minZoom: 5
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_119_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Щільність забруднення стронцієм-137",
                geoJsonName_rus: "Плотность загрязнения стронцием-137",
                geoJsonName_eng: "Contamination density by strontium-137 "
            }));
