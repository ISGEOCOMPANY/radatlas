LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.Center = [50.95, 28.63];
        this._mapSettings.MapZone = 4;

        //Nrz
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Забруднення територій цезієм-137 (за матеріалами аерогаммазйомки), місто Коростень",
                mapName_rus: "Загрязнение территорий цезием-137 (по материалам аэрогаммасъемки). Город Коростень",
                mapName_eng: "Contamination of the territories by cesium-137 (according to materials of aerial gamma survey), Korosten city",
                maxZoom: 14,
                minZoom: 12
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_49_01,
            {
                FindProperties: {
                    ukr: [
                        {
