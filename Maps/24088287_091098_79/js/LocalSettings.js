LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Прогноз забруднення зони відчуження америцієм-241 на 2056 рік",
                mapName_rus: "Прогноз загрязнения зоны отчуждения америцием-241 на 2056 год",
                mapName_eng: "Prediction of contamination of the exclusion zone by americium-241 for 2056",
                maxZoom: 12,
                minZoom: 9
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_79_01,
            {
                FindProperties: {
                    ukr: [
                        {
