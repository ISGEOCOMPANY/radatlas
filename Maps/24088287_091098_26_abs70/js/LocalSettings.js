LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Сумарні ефективні дози зовнішнього та внутрішнього (від радіоізотопів цезію, стронцію та трансуранових елементів) опромінення, розраховані на період 1986-2055 роки (70 років після аварії)",
                mapName_rus: "Суммарные эффективные дозы внешнего и внутреннего (от радиоизотопов цезия, стронция и трансурановых элементов) облучения, рассчитанные на период 1986-2055 годы (70 лет после аварии) ",
                mapName_eng: "Total effective doses for external and internal (caused by radioisotopes cesium, strontium and transuranium elements) irradiation, calculated for 1986-2055 (70 years after the accident)",
                maxZoom: 8,
                minZoom: 5
            });

        //Векторный слой по умолчанию
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_26_abs70_01,
            {
                FindProperties: {
                    ukr: [
                        {
