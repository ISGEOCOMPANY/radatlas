LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Забруднення зони відчуження ізотопами плутонію",
                mapName_rus: "Загрязнение зоны отчуждения изотопами плутония",
                mapName_eng: "Contamination of the exclusion zone by plutonium isotopes",
                maxZoom: 12,
                minZoom: 9
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_33_01,
            {
                FindProperties: {
                    ukr: [
                        {
