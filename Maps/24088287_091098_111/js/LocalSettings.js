LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Забруднення зони відчуження стронцієм-90 (станом на 10 травня 1986 року)",
                mapName_rus: "Загрязнение зоны отчуждения стронцием-90 (по состоянию на 10 мая 1986 года)",
                mapName_eng: "Contamination of the exclusion zone by strontium-90 (as of May 10, 1986)",
                maxZoom: 12,
                minZoom: 9
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_111_01,
            {
                FindProperties: {
                    ukr: [
                        {
