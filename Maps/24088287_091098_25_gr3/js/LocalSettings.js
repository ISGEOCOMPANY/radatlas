LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Доза опромінення щитоподібної залози. Третя вікова група (від 4 до 7 років на момент аварії)",
                mapName_rus: "Доза облучения щитовидной железы. Третья возрастная группа (от 4 до 7 лет на момент аварии)",
                mapName_eng: "Thyroid gland irradiation dose. Third age group (from 4 to 7 years at the moment of accident)",
                maxZoom: 8,
                minZoom: 5
            });

        //Векторный слой по умолчанию
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_25_gr3_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Доза опромінення щитоподібної залози. Третя вікова група",
                geoJsonName_rus: "Доза облучения щитовидной железы. Третья возрастная группа",
                geoJsonName_eng: "Thyroid gland irradiation dose. Third age group"
            }));
