LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Забруднення території України цезієм-137 (станом на 1 липня 1985 року)",
                mapName_rus: "Загрязнение территории Украины цезием-137 (по состоянию на 1 июля 1985 года)",
                mapName_eng: "Contamination of the territory of Ukraine by cesium-137 (as of July 1, 1985)",
                maxZoom: 7,
                minZoom: 5
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_70_01,
            {
                FindProperties: {
                    ukr: [
                        {
