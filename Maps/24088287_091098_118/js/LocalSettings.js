LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                ...
                mapName_eng: "Contamination of the territory of Ukraine by cesium-137 (as of May 10, 2014)",
                maxZoom: 8,
                minZoom: 5
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_118_01,
            {
                FindProperties: {
                    ukr: [
                        {
