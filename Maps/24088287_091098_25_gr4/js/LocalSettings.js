LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Доза опромінення щитоподібної залози. Четверта вікова група (від 8 до 11 років на момент аварії)",
                mapName_rus: "Доза облучения щитовидной железы. Четвертая возрастная группа (от 8 до 11 лет на момент аварии)",
                mapName_eng: "Thyroid gland irradiation dose. Fourth age group (from 8 to 11 years at the moment of accident)",
                maxZoom: 8,
                minZoom: 5
            });

        //Векторный слой по умолчанию
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_25_gr4_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Доза опромінення щитоподібної залози. Четверта вікова група",
                geoJsonName_rus: "Доза облучения щитовидной железы. Четвертая возрастная группа",
                geoJsonName_eng: "Thyroid gland irradiation dose. Fourth age group"
            }));
