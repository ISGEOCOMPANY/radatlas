LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Доза опромінення щитоподібної залози. Перша вікова група (страші 18 років на момент аварії)",
                mapName_rus: "Доза облучения щитовидной железы. Первая возрастная группа (старше 18 лет на момент аварии)",
                mapName_eng: "Thyroid gland irradiation dose. Seventh age group (older 18 year at the moment of accident)",
                maxZoom: 8,
                minZoom: 5
            });

        //Векторный слой по умолчанию
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_25_gr7_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Доза опромінення щитоподібної залози. Сьома вікова група",
                geoJsonName_rus: "Доза облучения щитовидной железы. Седьмая возрастная группа",
                geoJsonName_eng: "Thyroid gland irradiation dose. Seventh age group"
            }));
