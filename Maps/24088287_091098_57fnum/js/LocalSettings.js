LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        //GeoJson
        this._mapSettings.OptionalGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_57_02,
            {
                minZoom: 6,
                maxZoom: 8,
                onEachFeature: function (feature, layer) {
        ...
        //Labels 7,8. Диаграммы
        this._mapSettings.LabelLayers.push(new L.geoJson(Them1_57_lbl, {
            pointToLayer: function (feature, latlng) {
                return L.circleMarker(latlng, {
                    opacity: 0,
                    fillOpacity: 0
