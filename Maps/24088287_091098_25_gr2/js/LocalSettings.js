LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Доза опромінення щитоподібної залози. Друга  вікова група (від 1 до 3 років на момент аварії)",
                mapName_rus: "Доза облучения щитовидной железы. Вторая возрастная группа (от 1 года до 3 лет на момент аварии)",
                mapName_eng: "Thyroid gland irradiation dose. Second age group (from 1 to 3 years at the moment of accident)",
                maxZoom: 8,
                minZoom: 5
            });

        //Векторный слой по умолчанию
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_25_gr2_01,
            {
                FindProperties: {
                    ukr: [
                        {
                ...
                geoJsonName_ukr: "Доза опромінення щитоподібної залози. Друга вікова група",
                geoJsonName_rus: "Доза облучения щитовидной железы. Вторая возрастная группа",
                geoJsonName_eng: "Thyroid gland irradiation dose. Second age group"
            }));
