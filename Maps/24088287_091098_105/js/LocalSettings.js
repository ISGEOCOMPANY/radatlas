LocalSettings = Class.extend({
    ...
    setSettings: function (aSettings) {
        ...
        this._mapSettings.DefaultNRZLayer = new L.TileLayer(this._NRZFolderName + "Z{z}/{y}/{x}.png",
            {
                mapName_ukr: "Забруднення території України цезієм-137 (станом на 10 травня 1986 року)",
                mapName_rus: "Загрязнение территории Украины цезием-137 (по состоянию на 10 мая 1986 года)",
                mapName_eng: "Contamination of the territory of Ukraine by cesium-137 (as of May 10, 1986)",
                maxZoom: 8,
                minZoom: 5
            });
        ...
        //GeoJson
        this._mapSettings.DefaultGeoJsonLayers.push(new L.geoJson(Layer_24088287_091098_105_01,
            {
                FindProperties: {
                    ukr: [
                        {
